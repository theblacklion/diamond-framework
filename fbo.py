# File copied from https://code.google.com/p/pyprocessing/source/browse/trunk/tools/fbo.py?r=61
...
class FBO(object):
    ...
    def __init__(self, width=100, height=100):
        ...
        # self.pyglet_image = pyglet.image.create(self.width, self.height)
        # self.pyglet_texture = self.pyglet_image.get_texture()
        # self.img = self.pyglet_texture.id
