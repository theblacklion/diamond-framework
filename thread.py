...
class AbstractThread(Thread):
    ...
    def __init__(self):
        ...
        self.sleep_timeout = 1.0 / 60  # TODO should we base this on our framerate or vsync?
    ...
    def run(self):
        ...
        while self.state == AbstractThread.STATE_RUNNING:
            ...
            # print duration, self.sleep_timeout * 1000,
            if next_tick is not None:
                # print start, next_tick, next_tick - start
                sleep = next_tick - start
            else:
                # print None
                sleep = 0
            timeout = self.sleep_timeout - (duration / 1000.0)
            # print 1, timeout, sleep
            timeout += sleep / 1000.0
            # print 2, timeout
